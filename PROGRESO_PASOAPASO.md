...
199. **[ANCHO COMPLETO Y BOTONES DE RANGO]** Ampliada la vista del Dashboard a pantalla completa (100% width) e integrados los botones de selección rápida de rango (**7 días**, **30 días**, **90 días** y **Rango**) en el encabezado entre el selector de canal y el selector de fechas, permitiendo alternar dinámicamente el periodo de consulta.
200. **[CALENDARIOS EN TEMA CLARO]** Corregido el contraste de color del selector de fechas (Flatpickr) en Tema Claro. Se configuraron las propiedades CSS dinámicas para encabezados, días de la semana, números de días, meses y flechas de navegación utilizando variables del sistema (`var(--text-primary)`, `var(--card-bg)`), garantizando perfecta legibilidad tanto en modo claro como en modo oscuro.
201. **[DESPLIEGUE MEJORAS Y FIX CALENDARIO]** Cambios subidos exitosamente a GitHub (`master`) y desplegados en Vercel (`https://dashboard-ingrill-unificado.vercel.app`).
